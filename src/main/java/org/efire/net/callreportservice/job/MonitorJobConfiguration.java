 ...
 */
@Configuration
@Conditional(MonitorJobCondition.class)
@EnableBatchProcessing
public class MonitorJobConfiguration {
    ...
    @Bean
    public Job monitoringReportJob(JobBuilderFactory jbf) {

        return jbf.get("monitoringReportJob")
    ...
    @Bean
    public ItemWriter<CallReport> reportOutputWriter(@Value("${file.location.output-monitor}") String outputPath) {
